...
# CreateTime: 2020/1/7 2:36 下午
# Description: Alphabet.py
# Version: 1.0
...
import random
import collections
from Config.common import seed_num, unk, pad
...
class CreateAlphabet:
    ...
    def build_vocab(self):
        ...
        self.word_paddingId = self.word_alphabet.from_string(pad)
...
class Alphabet:
    ...
    def initial_from_pretrain(self, pretrain_file, unkkey, paddingkey):
        """
        :param pretrain_file:
        :param unkkey:
        :param paddingkey:
